...
textContent.textContent =
  "Everything indicates that they intend to raid the Museum. But sources told us they don't have enough money to get their tickets.";
...
btnHotel.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "He sold a wig that he made with his dark hair and mentioned being an artist.";
...
btnLibrary.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "He threated the security guard with his belt, but gave up saying he was tired.";
...
btnBank.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "He attempted to rob the ATM and failed. He escaped in his Cadillac saying he would learn how to break the system.";
...
btnMuseum.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "He took the cheapest piece of art and mentioned it being enough to sell and buy a plane ticket.";
