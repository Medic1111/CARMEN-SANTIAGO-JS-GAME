...
textContent.textContent =
  "Last night they bought tickets to France. They should have arrived in the morning. Good luck.";
...
btnHotel.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "The person you are looking for checked out in a rush and mentioned wanting to buy a historic belt.";
...
btnLibrary.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "I could not see the face because the sun shone on the blonde hair and blinded me. But I heard something about storing a belt in a safe.";
...
btnBank.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "He stored a belt in our safe, dropped his plane ticket without noticing.";
...
btnMuseum.addEventListener("click", () => {
  ...
  if (!booleanLocation) {
    ...
    textContent.textContent =
      "The person you are looking for left on a Suburban, wanting to learn more about their purchase.";
